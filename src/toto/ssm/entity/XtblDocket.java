...
public class XtblDocket implements java.io.Serializable {
	...
	public XtblDocket(long id, String admix1ap, String admix2ap, String admix3ap, String admix4ap,
			String agg1mix, String agg1sp, String agg2mix, String agg2sp, String agg3mix, String agg3sp, String agg4mix,
			String agg4sp, String cemt1mix, String cemt1sp, String cemt2mix, String cemt2sp, String cemt3mix,
			String cemt3sp, String cemt4mix, String cemt4sp, String countdoc, String dptype, String datebatch,
			String docketno, String docketref, String driver, String finished, String fuel, String moist1,
			String moist2, String moist3, String moist4, String price, String qf, String qn, String qtybatch,
			String qtydocket, String qtynet, String qtyperbatch, String qtytruck, String qw, String remark,
			String status, String temp0, String temp1, Date timeEx, Date timeLoad, String totalcost, String uploaded,
			String vat, String wc, String watersp, Date createDate, String createUser, Date updateDate) {
		this.id = id;
	...
	@TableGenerator(name = "SSMGen", table = "ID_GEN", pkColumnName = "GEN_KEY", valueColumnName = "GEN_VALUE", pkColumnValue = "XTBLDOCKET_ID", allocationSize = 1)
	@Id
	@Column(name = "id")
...
//    }
	...
	@Column(name = "admix1ap", length = 15)
	...
	@Column(name = "admix2ap", length = 15)
	...
	@Column(name = "admix3ap", length = 15)
	...
	@Column(name = "admix4ap", length = 15)
	...
	@Column(name = "cemt1mix", length = 15)
	...
	@Column(name = "cemt2mix", length = 15)
	...
	@Column(name = "cemt3mix", length = 15)
	...
	@Column(name = "cemt4mix", length = 15)
	...
	@Column(name = "countdoc", length = 15)
	...
	@Column(name = "datebatch", length = 15)
	...
	@Column(name = "docketno", length = 15)
	...
	@Column(name = "docketref", length = 15)
	...
	@Column(name = "finished", length = 15)
	...
	@Column(name = "qtybatch", length = 15)
	...
	@Column(name = "qtydocket", length = 15)
	...
	@Column(name = "qtyperbatch", length = 15)
	...
	@Column(name = "qtytruck", length = 15)
	...
	@Column(name = "totalcost", length = 15)
	...
	@Column(name = "uploaded", length = 15)
