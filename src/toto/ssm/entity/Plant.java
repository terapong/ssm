...
public class Plant  implements java.io.Serializable {
 ...
 public Plant(long id, String address, String attachments, String businessPhone, String city, String company,
		String countryRegion, Date createDate, String createUser, String emailAddress, String faxNumber,
		String firstName, String homePhone, String jobTitle, String lastName, String mobilePhone, String notes,
		String stateProvince, Date updateDate, String webPage, String zipPostalCode) {
	super();
	this.id = id;
...
//	@OneToOne(fetch = FetchType.LAZY, cascade=CascadeType.ALL, mappedBy = "plant")
